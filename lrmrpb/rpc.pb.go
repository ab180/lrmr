...
type CreateTaskRequest struct {
	...
	Stage       *pbtypes.JSON     `protobuf:"bytes,2,opt,name=stage,proto3" json:"stage,omitempty"`
...
func (m *CreateTaskRequest) GetJob() *Job {
	if m != nil {
		return m.Job
	}
	return nil
...
func (m *CreateTaskRequest) GetStage() *pbtypes.JSON {
	if m != nil {
		return m.Stage
	}
	return nil
...
type Input struct {
	...
	PrevStage *pbtypes.JSON `protobuf:"bytes,2,opt,name=prevStage,proto3" json:"prevStage,omitempty"`
}
...
func (m *Input) GetPrevStage() *pbtypes.JSON {
	if m != nil {
		return m.PrevStage
	}
	return nil
...
type Output struct {
	...
	NextStage  *pbtypes.JSON `protobuf:"bytes,2,opt,name=nextStage,proto3" json:"nextStage,omitempty"`
	OutputDesc *pbtypes.JSON `protobuf:"bytes,3,opt,name=outputDesc,proto3" json:"outputDesc,omitempty"`
...
func (m *Output) GetNextStage() *pbtypes.JSON {
	if m != nil {
		return m.NextStage
	}
	return nil
...
func (m *Output) GetOutputDesc() *pbtypes.JSON {
	if m != nil {
		return m.OutputDesc
	}
	return nil
...
var fileDescriptor_f4e130d388338f6d = []byte{
	...
	,
}
...
func (m *Input) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.PrevStage != nil {
		{
			size, err := m.PrevStage.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Output) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.OutputDesc != nil {
		{
			size, err := m.OutputDesc.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.NextStage != nil {
		{
			size, err := m.NextStage.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Input) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PrevStage", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PrevStage == nil {
				m.PrevStage = &pbtypes.JSON{}
			}
			if err := m.PrevStage.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *Output) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NextStage", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.NextStage == nil {
				m.NextStage = &pbtypes.JSON{}
			}
			if err := m.NextStage.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OutputDesc", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.OutputDesc == nil {
				m.OutputDesc = &pbtypes.JSON{}
			}
			if err := m.OutputDesc.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
